...
import { parsePvpCostModeCostConfig } from '../bytes2json/pvpCostModeCost'
import { parsePvpCostModeVoteConfig } from '../bytes2json/pvpCostModeVote'
import { parsePvpCostModeVotePriceConfig } from '../bytes2json/pvpCostModeVotePrice'
...
safeRun('pvpCostMode_cost', () => {
  parsePvpCostModeCostConfig('./ConfigPackage/export/pvpCostMode_cost.bytes')
})
safeRun('pvpCostMode_vote', () => {
  parsePvpCostModeVoteConfig('./ConfigPackage/export/pvpCostMode_vote.bytes')
})
safeRun('pvpCostMode_votePrice', () => {
  parsePvpCostModeVotePriceConfig(
    './ConfigPackage/export/pvpCostMode_votePrice.bytes',
  )
})
safeRun('language', () => {
...
safeRun('autocardCondition', () => {
  parseAutocardConditionConfig('./ConfigPackage/export/autocardCondition.bytes')
})
